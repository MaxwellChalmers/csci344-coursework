...
const getOnlyImgURList = (statArray) => {
  ridUndefs = (item) => item !== "NO PICTURE";
  return getImgURList(statArray).filter(ridUndefs);
};
/**
...
console.log(getImgURList(statuses));

console.log(getOnlyImgURList(statuses));
